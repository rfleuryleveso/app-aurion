...
open class AurionMock : IAurion {
    ...
    override fun getAllMarks(): ArrayList<IMark> {
        val IMarks = ArrayList<IMark>();

        val IMark1 = object : IMark {
